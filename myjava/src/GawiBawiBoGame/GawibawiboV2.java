...
public class GawibawiboV2 {
	...
	public static void main(String[] args) {
		 ...
		 * 3.2 play() 에서 호출된 객체는 사용자로부터 email을 입력 받아서 필드로 저장을 해야 합니다.
		 * 3.3 필요에 따라서 사용자의 ID가 뭔지를 리턴 받을 수 있는 getter()를 구현하세요
		 * 3.4 이 클래스 <-- 여기까지가 클래스1
		 * 3.5 여기서부터 클래스2 --> 내부에는 사용자 이름을 입력 받고 난 후 실제 게임을 진행 하는
		 ...
		 * 되어야 할 수 있으면, 어떤 메서드는 리턴을 해야 합니다.
		 * 
		 * 
		 * 위 조건을 잘 헤어려서 정의 해보세요.
		 * 
		 */
	}
}
