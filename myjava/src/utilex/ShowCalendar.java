...
/*
 * roll() : 필드의 값을 증가시키는 메서드.. 다른 필드엔 영향없음..
 * 단, 일필드가 말일일 경우, 월드 ==월을 변결하는 케이스엔 일필드가 변경된다.
 * 
...
public class ShowCalendar {
	public static void main(String[] args) {
		...
		if (input != null) {
			...
			// 날짜를 출력 시키는데 , 2가지 생각해야함
			// 1. 정렬 : 10일 이전은 문자가 하나이고, 이후는 2개임..따라서
			// 공백을 적절히 이용해서 정렬을 해줄 예정입니다.(2칸, 1칸)
			// 2. 일요일 ~ 토요일 까지 출력후 라인을 변경해서 다시날짜를 출력해야하는데
			// 그 기준점이 일주일 기준인 7입니다. 따라서 % 를 사용해 주 변경을 하도록 합니다.
