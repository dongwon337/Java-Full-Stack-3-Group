...
public class CalendarExam {
	...
	public static void main(String[] args) {
		...
		System.out.println("rightNow 는" + toString(rightNow) + DAY_OF_WEEK[rightNow.get(Calendar.DAY_OF_WEEK)] + " 요일입니다.");
		System.out.println("rightNow2 는" + toString(rightNow2) + DAY_OF_WEEK[rightNow2.get(Calendar.DAY_OF_WEEK)] + " 요일입니다.");
