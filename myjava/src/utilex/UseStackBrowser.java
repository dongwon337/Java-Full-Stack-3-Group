...
public class UseStackBrowser {
	...
	public static Stack<String> forward = new Stack<String>();//forward 생성시 주소값
	...
	public static void goURL(String url) {
		//아래는 Runtime 클래스의 유용한 메서드중 OS 의 특징 exe 를 동적으로 호출하여
		//실행하는 메서드를 사용합니다. 여기서 주어지는 파라미터가 윈도우에 있고, 이름이
		//정확하다면 실행이 되어집니다.
		Runtime runtime = Runtime.getRuntime();
		
		try {
			runtime.exec("C:\\Program Files\\Google\\Chrome\\Application\\chrome.exe " + url);
		} catch (IOException e) {
