...
/*
 * Stack 2개를 이용해서 웹 브라우저의 back, forward 의 URL 저장 하는 방법을 알아봅니다.
 */
public class UseStackBrowser {
	...
	public static Stack<String> forward = new Stack<String>();//forward 시 주소값
	...
	//브라우저의 로케이터에 URL 을입력하는 기능의 메서드를 정의 합니다.
	...
	public static void forForward() {
		//항상 주의 해야할 건, 객체는 null, collection 들은 요소가 있는지 여부를
