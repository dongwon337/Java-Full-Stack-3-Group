...
/*
 * 중첩 클래스(Nested Class) : 자바에서는 4대 중첩 클래스가 존재합니다.
 * 멤버중첩, 정적(static) 중첩, 지역 중첩, 익명 중첩
 * 
 * 이렇게 중첩 클래스 OR 중첩 인터페이스를 두는 이유는 특정 클래스가 외부에 노출되어
 * 어떤일을 하기보다는, 특정 클래스에서만 사용되어야 하고, 또한 코드의 복잡성을 내부에 감추어서
 * 사용하기 편하도록 하는데 있습니다.
 * 
