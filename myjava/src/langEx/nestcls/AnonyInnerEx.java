...
/*
 * 익명 클래스는 말 그대로 이름이 없는 클래스 입니다.
 * 이 뜻은 특정 클래스 또는 인터페이스 타입에 적용된 메서드나 생성자에
 * 바로 클래스를 정의후 특정 메서드를 호출하는 방식입니다.
 * 
...
// TestAnonyInner 구현 클래스.. 이걸 익명으로 변환한게 new
//
//	@Override
...
public class AnonyInnerEx {
	...
	public static void main(String[] args) {
		...
		UserAnonyInner u = new UserAnonyInner();
		u.test();
