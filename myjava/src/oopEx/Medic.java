...
public class Medic extends Terran implements Moveable {//클래스에는 public or default 만 존재함.
...
//	}
	...
	public void healing(String target) {
		System.out.println(getTheUnit() + name + "가 " + target + "을 치료합니다.");
	}
}
